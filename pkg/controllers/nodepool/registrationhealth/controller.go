...
var controllerMetric = metrics.Value{Name: "nodepool.registrationhealth", Help: "Resets the NodeRegistrationHealthy condition to Unknown when the NodePool or NodeClass spec changes."}
