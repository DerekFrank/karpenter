...
var vpaControllerMetric = metrics.Value{
	Name: "vpa.prediction",
	Help: "Polls VerticalPodAutoscaler objects and caches predicted post-recreation pod resources in a prediction store.",
}
