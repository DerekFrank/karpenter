...
var nodepoolControllerMetric = metrics.Value{Name: "state.nodepool", Help: "Watches NodePools to re-trigger consolidation on change and drop deleted NodePools from cost tracking."}
