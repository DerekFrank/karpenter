...
var controllerMetric = metrics.Value{Name: "state.nodeclaimgc", Help: "Garbage-collects stale unlaunched NodeClaim entries from cluster state once deleted from the API server."}
