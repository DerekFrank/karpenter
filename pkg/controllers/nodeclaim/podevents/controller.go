...
var controllerMetric = metrics.Value{Name: "nodeclaim.podevents", Help: "Stamps a NodeClaim with the time of its latest pod bind, terminal, or terminating event."}
