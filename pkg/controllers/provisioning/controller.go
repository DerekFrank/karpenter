...
var podTriggerControllerMetric = metrics.Value{
	Name: "provisioner.trigger.pod",
	Help: "Triggers provisioning in response to unschedulable pod changes.",
}
...
// Reconcile the resource
var nodeTriggerControllerMetric = metrics.Value{
	Name: "provisioner.trigger.node",
	Help: "Triggers provisioning for nodes tainted for disruption so their pods can reschedule.",
}
