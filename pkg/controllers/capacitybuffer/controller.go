...
var controllerMetric = metrics.Value{Name: "capacitybuffer", Help: "Resolves each CapacityBuffer's pod template and target replicas, updating its status for the provisioner."}
