...
var controllerMetric = metrics.Value{Name: "static.deprovisioning", Help: "Deletes excess NodeClaims to scale a static NodePool down to its desired replica count."}
