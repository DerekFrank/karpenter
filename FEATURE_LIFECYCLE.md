...
Once a feature is accepted, the priority label tells you whether to invest effort:

| Priority | What it means for contributors |
|----------|-------------------------------|
| `priority/important-soon` | We will review an RFC/PR if one is submitted |
| `priority/backlog` | We want to do this, but can only absorb so much at one time - an RFC/PR will likely not get reviewed if submitted right now |
...
Karpenter's release cadence is TBD. Merged features will be included in the next release.
